              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Center(child: ShimmerPlaceholder(width: 190, height: 18)),
                    const SizedBox(height: 8),
                    const Center(child: ShimmerPlaceholder(width: 240, height: 60)),
                    const SizedBox(height: 32),
                    const Row(
                      children: [
                        Expanded(child: ShimmerPlaceholder(height: 104, borderRadius: 20)),
                        SizedBox(width: 14),
                        Expanded(child: ShimmerPlaceholder(height: 104, borderRadius: 20)),
                      ],
                    ),
